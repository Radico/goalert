...
import { ServiceNotificationRule, ServiceUrgency } from '../../schema'
...
// They are only sent for the 'scheduled' urgency, since the backend clears them
// for every other one.
export function alertScheduleInput(
  urgency: ServiceUrgency | undefined,
  zone: string | undefined,
  rules: AlertScheduleRule[] | undefined,
): Record<string, unknown> {
  if (urgency !== 'scheduled') return {}
