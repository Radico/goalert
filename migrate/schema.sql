...
-- DATA=94c63b5e1c250ee2f66311493bad9a3866482df59c4eb25daafbe9da98e99b1d  -
-- DISK=dd463968a02b049a67c334cd7ac885fb0f8c6f1cd559c3d3cb624f83cd143f3c  -
-- PSQL=dd463968a02b049a67c334cd7ac885fb0f8c6f1cd559c3d3cb624f83cd143f3c  -
--
...
CREATE TABLE services (
	alert_schedule_enabled boolean DEFAULT false NOT NULL,
	description text DEFAULT ''::text NOT NULL,
	escalation_policy_id uuid NOT NULL,
	id uuid DEFAULT gen_random_uuid() NOT NULL,
	...
	CONSTRAINT services_notification_time_zone_check CHECK (NOT alert_schedule_enabled OR notification_time_zone IS NOT NULL),
...
CREATE INDEX idx_services_alert_schedule ON public.services USING btree (id) WHERE (alert_schedule_enabled OR notification_suppressed);
