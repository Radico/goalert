...
-- DATA=87c4a95dc13777daa8c49f3927b24b7c7b459a4d54eaebbd6f9b39e5b7d82e06  -
-- DISK=efd3486a63c657adbc2e22b2fdded6ed36aaaa6332e99bcf27d15488be517dbc  -
-- PSQL=efd3486a63c657adbc2e22b2fdded6ed36aaaa6332e99bcf27d15488be517dbc  -
--
...
CREATE TABLE alerts (
	...
	CONSTRAINT alerts_assigned_user_id_fkey FOREIGN KEY (assigned_user_id) REFERENCES users(id) ON DELETE SET NULL,
...
CREATE INDEX idx_alerts_assigned_user ON public.alerts USING btree (assigned_user_id) WHERE (assigned_user_id IS NOT NULL);
...
CREATE INDEX idx_ep_step_on_call_step ON public.ep_step_on_call_users USING btree (ep_step_id) WHERE (end_time IS NULL);
...
CREATE TABLE service_notification_rules (
	...
	CONSTRAINT service_notification_rules_pkey PRIMARY KEY (id),
	CONSTRAINT service_notification_rules_service_id_fkey FOREIGN KEY (service_id) REFERENCES services(id) ON DELETE CASCADE
);

CREATE INDEX idx_service_notification_rules_service ON public.service_notification_rules USING btree (service_id);
CREATE UNIQUE INDEX service_notification_rules_pkey ON public.service_notification_rules USING btree (id);
...
CREATE TABLE services (
	...
	notification_urgency text DEFAULT 'high'::text NOT NULL,
	...
	CONSTRAINT services_notification_time_zone_check CHECK (notification_urgency <> 'scheduled'::text OR notification_time_zone IS NOT NULL),
	CONSTRAINT services_notification_urgency_check CHECK (notification_urgency = ANY (ARRAY['high'::text, 'low'::text, 'scheduled'::text])),
...
CREATE INDEX idx_services_alert_schedule ON public.services USING btree (id) WHERE ((notification_urgency = 'scheduled'::text) OR notification_suppressed);
